...
const semanticErrors = [
  [
    "inproper variable declarations",
    "int x := 1.0f; string f := 10.0; string var = 10.0f;",
  ],
  ["invalid variable assignments", 'x = 1; f = 10.0f; var = \"test\";'],
  ["inproper typecast", "int x := 1; bool y := (bool) x;"],
  [
    "invalid whileLoop",
    "int x := 1; int y := 2; bool z := true; while (x < z && z) {x++;}",
  ],
  [
    "invalid whileLoop",
    "int x := 1; int y := 2; bool z := true; while (x < y && a) {x++;}",
  ],
  [
    "double else",
    `float x := 3.0f; int y := 3; if (((int) x) < y) {print("x is smaller than y");} else if (((int) x) > y) {print("x is greater than y");} else {print("x and y are equal");} else {print("x and y are equal");}`,
  ],
  [
    "double if",
    `float x := 3.0f; int y := 3; if (((int) x) < y) {print("x is smaller than y");} if (((int) x) < y) {print("x is smaller than y");} else if ((int) x > y) {print("x is greater than y");} else {print("x and y are equal");} else {print("x and y are equal");}`,
  ],
